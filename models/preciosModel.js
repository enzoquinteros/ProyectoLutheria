...
async function buscarPrecios(busqueda) {
    var query = "select * from precios where nombre like ? OR precio like ? OR descripcion like ? ";
    var rows = await pool.query(query, ['%' + busqueda + '%', '%' + busqueda + '%', '%' + busqueda + '%']);
    return rows;
}

module.exports = { getPrecios, deletePreciosById, insertPrecios, getPreciosById,modificarPreciosById, buscarPrecios}