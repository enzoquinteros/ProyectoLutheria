...
-- Tiempo de generación: 28-12-2022 a las 23:42:21
...
(4, 'Violin', 35000, 'El violín es un instrumento de cuerda frotada tocado con un arco. Cuenta con cuatro cuerdas tensadas cuya afinación es Mi, la, re, sol (desde la cuerda más delgada a la más gruesa). Este instrumento es muy dinámico, cuenta con gran flexibilidad y versatilidad en su rango tonal.', 'yhkzptpet6m9pf1up0t0'),
(5, 'Ronroco', 30000, 'El ronroco es un instrumento musical de Bolivia, de la familia de los charangos, mide aproximadamente 80 cm de longitud total​ y con una cuerda vibrante de hasta 50 cm. Este instrumento se caracteriza por su sonido ronco, y por ello tiene ese nombre.', 's9ddeltdinochboabmyf');
